  ...
  <div class="bg-[#E52323] mt-2 h-[40px]">
    <div class="container mx-auto">
      <ul class="flex text-white py-1 justify-between text-[18px]">
        <li class="hover:text-black hover:underline"><a href="<?= SITE_URL ?>">Trang chủ</a></li>
        <li class="hover:text-black hover:underline"><a href="<?= SITE_URL ?>?danhmuc">Sản phẩm</a></li>
        <li class="hover:text-black hover:underline"><a href="<?= SITE_URL ?>?gioithieu">Giới thiệu</a></li>
        <li class="hover:text-black hover:underline"><a href="<?= SITE_URL ?>?hoidap">Hỏi đáp</a></li>
      </ul>
    </div>
  </div>
