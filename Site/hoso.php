...
<body>
  ...
  <div class=" bg-neutral-100 max-w-screen-2xl m-auto    ">
    <div class="text-center h-20 text-5xl font-bold pt-2  ">
      <h2 class="font-mono ">Hồ Sơ Của Tôi</h2>
    </div>
    <div class="text-center m-auto  h-[400px] border-2  w-[900px] rounded-lg hover:bg-sky-200 ">
      
    <div class="pb-2 text-center pt-6">
      <i class="fa-solid fa-user"></i>
      <input type="text" id="name " placeholder="Ho-Tên :"
        class=" border-2 w-[800px] h-12 rounded-lg hover:border-orange-400 border-2  ">
    </div>
    <div class="pt-4 text-center">
      <i class="fa-solid fa-phone"></i>
      <input type="number" id="name " placeholder="Số điện thoại :"
        class=" border-2 w-[800px] h-12 rounded-lg hover:border-orange-400 border-2   ">
    </div>
    <div class="pt-4 text-center ">
      <i class="fa-solid fa-envelope"></i>
      <input type=" email" id="name " placeholder="Email :"
        class="  w-[800px] h-12 rounded-lg hover:border-orange-400 border-2  ">

    </div>
    <div class="pt-4 pb-4 text-center">
      <i class="fa-solid fa-location-dot "></i>
      <input type="text" id="name " placeholder="Địa chỉ :"
        class=" border-2 w-[800px] h-20 rounded-lg hover:border-orange-400 border-2  ">

    </div>
    <div class="text-center pb-4 ">
      <button class="bg-red-500 w-[120px]  h-[40px] text-xl rounded-md text-gray-300 "> <i
          class="fa-solid fa-paper-plane "></i> Thay đổi </button>
    </div>
