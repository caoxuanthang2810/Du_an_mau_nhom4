...
<body>
    <h1 class="text-center text-[36px] font-bold mb-6 mt-4">Cập nhật danh mục</h1>
    <div class="flex items-center justify-center">
        <form action="" class="w-[600px] rounded-[10px] border border-[#000] p-4 shadow shadow-[#000]" method="POST" enctype="multipart/form-data">
            ...
            <div class="pt-5">
                ...
                <input type="text" name="name" value="<?=$name_cate?>" class="border pl-2 border-[#000] h-[40px] w-[75%] rounded-[10px]">
            </div>
